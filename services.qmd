...
<button class="service-card" onclick="showPanel('panel_s1')">Consulting & Project Support</button>
<button class="service-card" onclick="showPanel('panel_s2')">Data Research & Compilation</button>
<button class="service-card" onclick="showPanel('panel_s3')">Surveillance & Monitoring</button>
<button class="service-card" onclick="showPanel('panel_s4')">Proof of Efficacy, Risk Assessment & Product Safety</button>
<button class="service-card" onclick="showPanel('panel_s5')">Animal Studies & Agricultural Field Trials</button>
<button class="service-card" onclick="showPanel('panel_s6')">Contract Research & Clinical Trials</button>
<button class="service-card" onclick="showPanel('panel_s7')">Kurs "Datenanalyse mit Python"</button>
</div>
</div>
